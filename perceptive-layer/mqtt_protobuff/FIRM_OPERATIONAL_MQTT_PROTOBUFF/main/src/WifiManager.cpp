...
const char* WifiManager::failReasonToString(FailReason reason) {
    switch(reason) {
        case FailReason::WIFI_FAIL_NONE: return "NONE";
        case FailReason::WIFI_FAIL_AUTH: return "AUTH FAIL";
        case FailReason::WIFI_FAIL_NO_AP: return "NO AP FOUND";
        case FailReason::WIFI_FAIL_MAX_RETRIES: return "MAX RETRIES";
        case FailReason::WIFI_FAIL_TIMEOUT: return "TIMEOUT";
        case FailReason::WIFI_FAIL_UNKNOWN: return "UNKNOWN";
...
static void set_failure(WifiManager::FailReason reason) {
    ...
    ESP_LOGE(TAG, "Wifi failed, reason: %s", WifiManager::failReasonToString(reason));
